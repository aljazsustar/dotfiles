...
theme.wallpaper                                 = "~/Pictures/wallpapers/0005.jpg"
...
-- Binary clock
local binclock = wibox.widget.textclock()
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#4B696D", "#CB755B"),
            --wibox.container.background(wibox.container.margin(wibox.widget { theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#CB755B"),
